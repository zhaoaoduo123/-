...
class CheckIDC:
    def __init__(self, id_number):
        ...
        self.lists = []
        self.lists.append(self.check_birthday(self.birthday))#0
        self.lists.append(self.validate_check_number())#1
        self.lists.append(self.validate_check_gender())#2
        self.lists.append(self.valedate_check_area())#3
        print(self.lists)
    def results(self):
        return self.lists
    ...
    def check_birthday(self, birthday):
        ...
        # 返回结果
        #print('----------------------------------------')
        # 1 3 0 1 8 3 2 0 0 0 0 1 2 1 0 8 9 7
        # 310101 19951010 132 5
    ...
    def validate_check_number(self):
        if self.get_check_number() == self.exits:#是否有效
            return '有效'
        else:
            return False
