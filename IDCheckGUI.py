...
class IDCheckGUI:
    def __init__(self):
        ...
        # 图片
        self.image = PhotoImage(file="D:/新建文件夹/4.png")
        ...
        self.Entry_is_input = Entry(self.frame, width=21, font=("微软雅黑", 12, "bold"))
